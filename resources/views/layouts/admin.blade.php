    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                <!--begin::Brand Link-->
                <a href="/admin/dashboard" class="brand-link logo-switch">
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <!-- Auto Reply -->
                        <li class="nav-item">
                            <a href="{{ url('/admin/auto-reply') }}"
                                class="nav-link {{ request()->is('admin/auto-reply*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-chat-dots-fill"></i>
                                <p>Auto Reply</p>
                            </a>
                        </li>

                        <!-- Bisa tambah menu lain seperti grup, log, dll -->
                        <!--
                        <li class="nav-item">
